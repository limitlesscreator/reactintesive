    ...
    return (
        <>
            ...
            <form>
                ...
                <Input deleteWhichEmpty={props.deleteWhichEmpty} operation={props.updatePhone}  data={props.data} value={props.data.phone} id={'phone'} text={'Т E Л Е Ф О Н'} placeholder={'00-000-000-00-00'} type={'tel'}/>
